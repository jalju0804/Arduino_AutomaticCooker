...
int pin_muxAddress_A = 4;   // PD4(XCK) 220815
int pin_muxAddress_B = 3;   // PD3(INT1) 220815
int pin_muxAddress_C = 2;   // PD2(INT0) 220815
...
int pin_WaterLevelSensor_1 = A3; // Recipe Water 220815
int pin_WaterLevelSensor_1_2 = A2; // new 220815
...
int pinTemps_SO = 14;     // PB6 220815
int pinTemps_SCK = 15;     // PB7 220815
